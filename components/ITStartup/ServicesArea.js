          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-6 col-md-12 services-content">
              <div className="section-title">
                ...
                <p>
                  Nos méthodologies et techniques de référencement naturel et
                  payant s’appliquent pour développer la visibilité des sites
                  web et leur efficacité commerciale. Nous sommes également en
                  mesure de produire du contenu de qualité et de le partager sur
                  les réseaux sociaux et autres supports digitaux pour le compte
                  de nos clients.
                </p>
              </div>
              ...
              <div className="row">
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Database /> Création stratégie de marque
                  </div>
                </div>
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Globe />
                    Conception de design graphique
                  </div>
                </div>
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.TrendingUp />
                    Création de contenu de réseaux sociaux
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row h-100 justify-content-center align-items-center">
            ...
            <div className="col-lg-6 col-md-12 services-content">
              <div className="section-title">
                ...
                <div className="bar"></div>
                <p>
                  Nous créons des sites internet sur mesure grâce à des
                  compétences pointues en design, intégration et développement,
                  administration de systèmes. Notre agence web est présente pour
                  maintenir le site et assister ses clients tout au long du
              ...
              <div className="row">
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Layout /> Création d'application mobile
                  </div>
                </div>
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Code /> Boutique en ligne
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Code /> Maintenance site
                  </div>
                </div>
              </div>
            </div>
